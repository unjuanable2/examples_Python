...
# 这里用它从 results_analysis/run_exp1_out.txt 里提取 Epoch、Learning Rate、Loss、Acc 等字段。
...
# 这里表示 “脚本所在文件夹/run_exp1_out.txt”，也就是 results_analysis/run_exp1_out.txt。
...
def parse_log(log_text):
    ...
    #
    # 参数 log_text：
    # - 是 results_analysis/run_exp1_out.txt 的完整文本内容；
